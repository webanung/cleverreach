...
namespace CleverReach\Infrastructure\ORM\Utility;

use CleverReach\Infrastructure\ORM\Entity;
use CleverReach\Infrastructure\ORM\Exceptions\EntityClassException;
use CleverReach\Infrastructure\ORM\IntermediateObject;
use CleverReach\Infrastructure\Utility\Serializer;

/**
 * Class EntityTranslator
 *
 * @package CleverReach\Infrastructure\ORM\Utility
 */
class EntityTranslator
{
    /**
